...
- "Rebuilt the healthcare AI multi-agent workflow with strict RBAC/ABAC access control, orchestrating clinical data flow between SOAP notes and billing-code agents while enforcing per-role document boundaries"
- "Rebuilt the SOAP notes generation agent and billing codes mapping agent end-to-end for production healthcare AI product, improving clinical documentation accuracy"

**<WORK_EXPERIENCE_COMPANY_1> Intern — for a Backend/API JD:**
- "Built FastAPI backend services for a production healthcare AI platform, implementing multi-agent orchestration with RBAC/ABAC access control across clinical data agents"
...
- "Implemented multi-agent orchestration in LangGraph across planner, summarization, and analytical agents with department-scoped access control for healthcare AI product"
...
- ❌ "Healthcare AI multi-agent pipeline, rebuilding SOAP notes..."
- ✅ "Rebuilt the healthcare AI pipeline's SOAP notes agent from scratch using Python and CrewAI..."
...
- ❌ "Delivered a <PR_TITLE_1> for a YC P25 platform..."
...
- ❌ "Rebuilding healthcare AI workflow with strict RBAC/ABAC access control -- orchestrating clinical data flow between agents"
...
- ✅ "Rebuilt the healthcare AI workflow with strict RBAC/ABAC access control, orchestrating clinical data flow between SOAP notes and billing-code agents while enforcing per-role document boundaries"
...
- ✅ For a healthcare AI JD: Lead with healthcare workflow, SOAP notes, billing codes
...
5. **No batch/label metadata** — no YC P25, funding rounds, etc. in bullet text
